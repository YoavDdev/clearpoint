-- =====================================================
-- Workaround - יצירה עם שמות זמניים
-- =====================================================

-- יצירת טבלאות עם שמות זמניים
...
CREATE TABLE subscription_history_new (
  id UUID PRIMARY KEY DEFAULT gen_random_uuid(),
  subscription_id UUID NOT NULL REFERENCES subscriptions_new(id) ON DELETE CASCADE,
  user_id UUID NOT NULL REFERENCES users(id) ON DELETE CASCADE,
...
SELECT '✅ Payment system created successfully with workaround!' as status;
