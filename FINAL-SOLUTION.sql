-- =====================================================
-- FINAL SOLUTION - פתרון סופי למערכת תשלומים
-- =====================================================
...
-- הוספת עמודות אחת אחת
ALTER TABLE subscriptions ADD COLUMN IF NOT EXISTS status TEXT NOT NULL DEFAULT 'active' CHECK (status IN ('active', 'cancelled', 'expired', 'paused', 'trial'));
...
ALTER TABLE subscriptions ADD COLUMN IF NOT EXISTS amount DECIMAL(10, 2) NOT NULL DEFAULT 0 CHECK (amount >= 0);
...
SELECT '🎉🎉🎉 מערכת התשלומים הושלמה בהצלחה! 🎉🎉🎉' as status;
