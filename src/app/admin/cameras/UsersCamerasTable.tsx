          ...
          {(() => {
            ...
            if (s === 'ok') {
              return (
                <span
                  ...
                  title={`${titlePrefix}כל המצלמות תקינות`}
                >
            ...
            if (s === 'issue') {
              return (
                <span
                  ...
                  title={`${titlePrefix}יש תקלה באחת המצלמות`}
                >
            ...
            return (
              <span
                ...
                title={`${titlePrefix}יש מצלמה לא מקוונת`}
              >
                <AlertCircle className="w-4 h-4" />
              </span>
            );
        ...
        <div className="mt-4">
          <div className="flex items-center justify-between mb-3">
            ...
            {expandedUserId !== "__unknown__" ? (
              ...
              <span className="text-xs text-slate-500">מצלמות ללא לקוח משויך</span>
            )}
          </div>
