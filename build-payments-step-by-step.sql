-- =====================================================
-- בניית מערכת התשלומים שלב אחר שלב
-- =====================================================

-- שלב 1: הוסף עמודות ל-subscriptions הקיימת
...
-- עדכן status עם CHECK constraint
...
SELECT '✅ שלב 1: subscriptions הורחבה' as status;

-- ========================================

-- שלב 2: צור טבלת payments
...
SELECT '✅ שלב 2: payments נוצרה' as status;

-- ========================================

-- שלב 3: צור טבלת subscription_history
...
SELECT '✅ שלב 3: subscription_history נוצרה' as status;
...
SELECT '✅ שלב 4: אינדקסים נוצרו' as status;

-- ========================================

-- שלב 5: עדכון טבלת users
...
SELECT '✅ שלב 5: users עודכנה' as status;
...
SELECT '✅ שלב 6: Triggers נוצרו' as status;
...
SELECT '✅ שלב 7: RLS Policies נוצרו' as status;
...
SELECT '✅ שלב 8: Views נוצרו' as status;
...
SELECT '🎉 מערכת התשלומים הושלמה בהצלחה!' as final_status;
