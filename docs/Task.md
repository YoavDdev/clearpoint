...
- [ ] **Meshulam Integration**: Implement Meshulam iframe or redirect flow for payments, store subscription info in Supabase, handle plan logic by status
...
- Improve `/forgot-password` UX to avoid email enumeration (always return same message)
